...
CLOTHING_VARIANT_CATALOG = {
    "tops": {
        "hot": [
            ...
            _pngimg("polo_shirt", "polo_shirt_PNG8142.png", "https://pngimg.com/image/8142", "Soft polo", "A lighter polo keeps the outfit clean without adding any unnecessary weight in the heat.", ["Soft tone", "Low bulk"]),
        ],
        "mild": [
            ...
            _pngimg("tshirt", "tshirt_PNG5435.png", "https://pngimg.com/image/5435", "Charcoal tee", "A darker tee still works well in mild weather when you want comfort with a slightly sharper finish.", ["Clean", "Versatile"]),
        ...
        "cool": [
            ...
            _pngimg("sweater", "sweater_PNG57.png", "https://pngimg.com/image/11646", "Neutral sweater", "A soft sweater is a cleaner cool-weather top when you want warmth without going straight to outerwear.", ["Soft knit", "Layerable"]),
            _pngimg("sweater", "sweater_PNG48.png", "https://pngimg.com/image/11637", "Dark sweater", "A darker sweater works well once cooler air makes lighter shirts feel underpowered.", ["Dense knit", "Cool-day fit"]),
            _pngimg("sweater", "sweater_PNG31.png", "https://pngimg.com/image/11620", "Classic sweater", "A classic knit gives the outfit more warmth than a shirt while staying visually simple.", ["Classic knit", "Balanced warmth"]),
        ...
        "cold": [
            ...
            _pngimg("sweater", "sweater_PNG57.png", "https://pngimg.com/image/11646", "Neutral winter sweater", "A denser sweater gives a cleaner cold-weather option when you want warmth without a bulky look.", ["Dense knit", "Winter"]),
            _pngimg("sweater", "sweater_PNG48.png", "https://pngimg.com/image/11637", "Dark winter sweater", "A darker heavier sweater works well once the weather demands more than a shirt or tee.", ["Heavy knit", "Cold-day"]),
            _pngimg("sweater", "sweater_PNG31.png", "https://pngimg.com/image/11620", "Classic winter knit", "A classic knit stays relevant in cold weather if the outfit is layered properly.", ["Classic", "Cold-ready"]),
